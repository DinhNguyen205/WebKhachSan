...
/* Khởi tạo mảng xác nhận nếu chưa có */
if (!isset($_SESSION['xacnhan'])) {
    $_SESSION['xacnhan'] = [];
}
...
if (isset($_GET['confirm'])) {
    $id = $_GET['confirm'];
    $_SESSION['xacnhan'][$id] = true;
    header("Location: quanlydatphong.php");
    exit();
}
// ================== KẾT NỐI DATABASE ==================
...
$result = $conn->query("SELECT * FROM datphong WHERE ten LIKE '%$keyword%' OR sodienthoai LIKE '%$keyword%'");
?>
